  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h1 className={`text-title text-semibold text-2xl`}>Exam</h1>
          ...
          <table className='w-full'>
            ...
            <tbody>
              <tr>
                ...
                <td className='pl-5 py-3 text-sm text-title'>June 22, 2022</td>
                <td
                  className='pl-5 py-3 text-sm text-semibold'
                  style={{
                    color: '#EB6200'
                  }}
                >
              ...
              <tr>
                ...
                <td
                  className='pl-5 py-3 text-sm text-semibold bg-lightBlue'
                  style={{
                    color: '#04A9F5'
                  }}
                >
