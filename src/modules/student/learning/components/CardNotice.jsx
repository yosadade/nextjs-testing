...
const CardNotice = ({ title, date, subTitle, attachment = false }) => {
  return (
    <div className='border-solid border-[1px] border-[#D0D0D0] rounded-[10px] mb-5 p-7'>
      ...
      {attachment && (
        <div className='pagination flex items-center justify-end mt-10'>
